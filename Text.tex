...
so one can assume that it can be defined in ${\bf I}\Delta_0(exp)$. 
...
\begin{proof}
  ...
  \end{center}
  This proof can be formalised in ${\bf I}\Delta_0(exp)$ to give
  \begin{center}
...
\begin{lemma}
  ${\bf I}\Delta_0(exp)$ proves the following formula
  \begin{center}
...
\end{center}
in a conservative extension of ${\bf I}\Delta_0(exp)$ and thus derive the following in ${\bf I}\Delta_0(exp)$
\begin{center}
  $\exists z H(\omega^a, x, y, z) \to \exists z H(\omega^a c, y, w, z) \to \exists z H(\omega^a(c + 1), x, w, z)$.
\end{center}
\end{proof}
...
\begin{proof}
  ...
  witnesses $H(\omega^0, x, x + 1, t_0)$ in ${\bf I}\Delta_0(exp)$, so we have $H(\omega^0)$.
